...
The output, known as a eigenvalue matrix, shows the correlation between the original variables and the Principal Components. We see that P
...
We see that states that are close to each other will have similar data patterns with one another. 
...
# Create a scree plot
plot(c(1:3), var_explained, type = "b",
