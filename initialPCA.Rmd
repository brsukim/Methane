...
MethaneData <- MethaneData %>% select(-Elevation, -Study_number, -Ecosystem_numeric, -Period_numeric)
...
Furthermore, the proximity of an observed point's (a state's) a variable vector is proportional to their association. 
